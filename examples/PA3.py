...
# Timezone set to Indian Standard Time (UTC+5:30)
UTC_PLUS_5_30 = pytz.timezone('Asia/Kolkata')

def ts_to_dt(ts):
    """Convert timestamp to UTC+5:30 datetime (Indian Standard Time)"""
...
async def process_signal(client, pair, direction, data):
    ...
    try:
        ...
        current_dt = datetime.now(UTC_PLUS_5_30)
        ...
        # প্রদর্শনের সময় (UTC+5:30) ফরম্যাট করুন
...
☲☲☲_ 【 𝐀𝙸 𝐒𝙸𝙶𝙽𝙰𝐋 𝐐𝚇 】☲☲☲☲"""
                    ...
                    print(rainbow_text(f"𝙼𝚊𝚛𝚝𝚒𝚗𝚐𝚊𝚕𝚎 𝚝𝚛𝚊𝚍𝚎 𝚏𝚘𝚛 {clean_asset} 𝚊𝚝 {formatted_time} 𝚎𝚗𝚍𝚎𝚍 𝚒𝚗 𝙱𝚛𝚎𝚊𝚔-𝚎𝚟𝚎𝚗 (𝚂𝚝𝚎𝙿 {martingale_step})."))
                    break
                elif mg_win:
