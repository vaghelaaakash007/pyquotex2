...
# ---------- Constants for Triple Confirmation strategy ---------- # <-- ADDED
...
# ---------- Stochastic indicator for Triple Confirmation ---------- # <-- ADDED
...
# ===================================================================
#  ORIGINAL TRADE BOT CODE (modified to use new strategies)
# ===================================================================
...
async def single_asset_mode(config):
    ...
    while True:
        ...
        if len(candle_data) < 20:
            print(f"   ⚠️  Only {len(candle_data)} candles, need more...")
            await asyncio.sleep(2)
            continue
