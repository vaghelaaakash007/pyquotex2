...
TELEGRAM_SOURCE_CHANNEL = ""  # সোর্স চ্যানেল ইউজারনাম (এখানে @ ছাড়া) - leave empty to disable
...
async def process_signal(client, pair, direction, data):
    ...
    try:
        ...
        # প্রদর্শনের সময় (IST) ফরম্যাট করুন
...
async def get_profitable_pairs(client, min_profit=70):
    ...
    if not assets:
        print(rainbow_text("𝚐𝚎𝚍_𝚊𝚕𝚕_𝚊𝚓𝚜𝚎𝚍 𝚛𝚎𝚝𝚞𝚗𝚎𝚍  𝚝𝚘𝚝𝚎. 𝚄𝚜𝚒𝚗𝚐 𝚏𝚒𝚕𝚝𝚎𝚛𝚎𝚍 𝚍𝚎𝚏𝚊𝚞𝚕𝚝 𝙿𝚊𝚛𝚛𝚜."))
